...
export default function CookieConsent() {
  ...
  const toggleCls = (on: boolean) =>
    `shrink-0 mt-0.5 w-9 h-5 rounded-full transition-colors duration-200 flex items-center px-0.5 ${
      on ? 'bg-[#E24B4A]' : 'bg-zinc-200'
    }`;
    ...
    <>
      ...
      {show && !showModal && (
        <div
          ...
          style={{ borderTop: '0.5px solid #E4E4E7' }}
        >
          <div className="max-w-wide mx-auto px-5 py-4 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <p className="text-[0.8rem] text-zinc-600 flex-1 leading-relaxed">
              ...
              <Link href="/privacy-policy" className="text-[#E24B4A] underline hover:text-[#C73B3A]">
                Privacy Policy
              </Link>
            </p>
            <div className="flex flex-wrap items-center gap-2 shrink-0">
              <button
                onClick={openModal}
                className="px-4 py-1.5 text-[0.775rem] font-medium text-zinc-600 border border-zinc-200 rounded hover:border-zinc-400 transition-colors"
              >
                Manage Preferences
              </button>
              <button
                onClick={rejectAll}
                className="px-4 py-1.5 text-[0.775rem] font-medium text-zinc-600 border border-zinc-200 rounded hover:bg-zinc-50 transition-colors"
              >
                Reject All
              </button>
              <button
                onClick={acceptAll}
                className="px-4 py-1.5 text-[0.775rem] font-medium bg-[#E24B4A] hover:bg-[#C73B3A] text-white rounded transition-colors"
              >
                Accept All
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-[110] flex items-end sm:items-center justify-center p-4">
          ...
          <div className="relative bg-white border border-zinc-200 rounded-lg w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: '0.5px solid #E4E4E7' }}>
              <h2 className="text-[0.9375rem] font-medium text-zinc-900">
                Cookie Preferences
              </h2>
              <button
                onClick={() => setShowModal(false)}
            ...
            <div className="px-5 py-4 space-y-4">
              ...
              <div className="flex items-start justify-between gap-4 pb-4" style={{ borderBottom: '0.5px solid #F4F4F5' }}>
                <div>
                  ...
                  <p className="text-[0.73rem] text-zinc-400 mt-0.5 leading-relaxed">
              ...
              <div className="flex items-start justify-between gap-4 pb-4" style={{ borderBottom: '0.5px solid #F4F4F5' }}>
                ...
                <button
                  ...
                  className={toggleCls(prefs.analytics)}
                >
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-[0.73rem] text-zinc-400 mt-0.5 leading-relaxed">
                    Enables share buttons (Twitter/X, Facebook, LinkedIn). Platforms may set their own cookies.
                  </p>
                </div>
                <button
                  role="switch"
                  ...
                  className={toggleCls(prefs.social)}
                >
            ...
            <div className="px-5 py-4 space-y-2" style={{ borderTop: '0.5px solid #E4E4E7' }}>
              <div className="flex gap-2">
                <button
                  onClick={rejectAll}
                  className="flex-1 px-4 py-1.5 text-[0.775rem] font-medium border border-zinc-200 rounded hover:bg-zinc-50 transition-colors"
                >
                  Reject All
                </button>
                <button
              ...
              <button
                onClick={savePrefs}
                className="w-full px-4 py-1.5 text-[0.775rem] font-medium bg-[#E24B4A] hover:bg-[#C73B3A] text-white rounded transition-colors"
              >
                Save My Preferences
              </button>
